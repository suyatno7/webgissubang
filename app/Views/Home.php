    ...
    <div class="container px-4 px-lg-5">
        <div class="row gx-4 gx-lg-5 justify-content-center">
            <div class="col-md-10 col-lg-8 col-xl-7 text-sm-start">
                <p>Subang adalah sebuah kabupaten di provinsi Jawa Barat, Indonesia. Ibu kotanya adalah Subang. Kabupaten ini berbatasan dengan Laut Jawa di utara, Kabupaten Indramayu di timur,
            ...
            <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="/assets/blog/images/bukitpasirjaka.jpg" class="d-block w-75 mx-auto" alt="1">
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Bukit Pasir Jaka</h5>
                        </div>
                    </div>
                    <div class="carousel-item">
                        <img src="/assets/blog/images/Pantai_pondok_bali.jpg" class="d-block w-75 mx-auto" alt="2">
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Pantai Pondok Bali</h5>
                        </div>
                    </div>
                    <div class="carousel-item">
                        <img src="/assets/blog/images/curug_luhur.jpg" class="d-block w-75 mx-auto" alt="3">
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Curug Luhur</h5>
                        </div>
                    </div>
